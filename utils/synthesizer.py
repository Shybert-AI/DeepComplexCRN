...
if __name__ == '__main__':
    # thchs30数据集是清华大学30小时的中文数据集可以在http://www.openslr.org/18/上下载。
    # origin speech data path
    noise_base = os.path.join("dataset", 'THCHS-30', 'test-noise/noise')
    train_speech_base = os.path.join("dataset", 'THCHS-30', 'data_thchs30/train')
    test_speech_base = os.path.join("dataset", 'THCHS-30', 'data_thchs30/test')

    # synthesized speech data path
    noise_dir = os.path.join("dataset", 'THCHS-30', 'data_synthesized/noise')
    train_dir = os.path.join("dataset", 'THCHS-30', 'data_synthesized/train')
    test_dir = os.path.join("dataset", 'THCHS-30', 'data_synthesized/test')
